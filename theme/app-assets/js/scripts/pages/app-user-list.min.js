$(function () {
    var e = $(".user-list-table"),
        ...
        s = $(".select2"),
        n = $(".dt-contact"),
        l = { 1: { title: "Pending", class: "badge-light-warning" }, 2: { title: "Active", class: "badge-light-success" }, 3: { title: "Inactive", class: "badge-light-secondary" } },
        o = "../../../app-assets/",
        r = "app-user-view-account.html";
    "laravel" === $("body").attr("data-framework") && ((o = $("body").attr("data-asset-path")), (r = o + "app/user/view/account")),
        s.each(function () {
            var e = $(this);
        ...
        e.DataTable({
            ...
            columns: [{ data: "" }, { data: "full_name" }, { data: "role" }, { data: "current_plan" }, { data: "billing" }, { data: "status" }, { data: "" }],
            columnDefs: [
                {
                    className: "control",
                    orderable: !1,
            ...
            order: [[1, "desc"]],
            dom:
                '<"d-flex justify-content-between align-items-center header-actions mx-2 row mt-75"<"col-sm-12 col-lg-4 d-flex justify-content-center justify-content-lg-start" l><"col-sm-12 col-lg-8 ps-xl-75 ps-0"<"dt-action-buttons d-flex align-items-center justify-content-center justify-content-lg-end flex-lg-nowrap flex-wrap"<"me-1"f>B>>>t<"d-flex justify-content-between mx-2 row mb-1"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
            ...
            buttons: [
                {
                    ...
                    buttons: [
                        { extend: "print", text: feather.icons.printer.toSvg({ class: "font-small-4 me-50" }) + "Print", className: "dropdown-item", exportOptions: { columns: [1, 2, 3, 4, 5] } },
                        { extend: "csv", text: feather.icons["file-text"].toSvg({ class: "font-small-4 me-50" }) + "Csv", className: "dropdown-item", exportOptions: { columns: [1, 2, 3, 4, 5] } },
                        { extend: "excel", text: feather.icons.file.toSvg({ class: "font-small-4 me-50" }) + "Excel", className: "dropdown-item", exportOptions: { columns: [1, 2, 3, 4, 5] } },
                        { extend: "pdf", text: feather.icons.clipboard.toSvg({ class: "font-small-4 me-50" }) + "Pdf", className: "dropdown-item", exportOptions: { columns: [1, 2, 3, 4, 5] } },
                        { extend: "copy", text: feather.icons.copy.toSvg({ class: "font-small-4 me-50" }) + "Copy", className: "dropdown-item", exportOptions: { columns: [1, 2, 3, 4, 5] } },
                    ],
                    init: function (e, t, a) {
            ...
            initComplete: function () {
                this.api()
                    ...
                    .every(function () {
                        var e = this,
                            t =
                                ($('<label class="form-label" for="UserRole">Role</label>').appendTo(".user_role"),
                    ...
                    this.api()
                        ...
                        .every(function () {
                            var e = this,
                                t =
                                    ($('<label class="form-label" for="UserPlan">Plan</label>').appendTo(".user_plan"),
                    ...
                    this.api()
                        ...
                        .every(function () {
                            var e = this,
                                t =
                                    ($('<label class="form-label" for="FilterTransaction">Status</label>').appendTo(".user_status"),
        ...
        a.length &&
        (a.validate({ errorClass: "error", rules: { "user-fullname": { required: !0 }, "user-name": { required: !0 }, "user-email": { required: !0 } } }),
